...
/*
  ...
  //cerating and inserting elements
  ...
  //header.append(message.cloneNode(true)); // to add it more than once
  ...
  // Don't use
  logo.className = 'jonas'; // this will override all existing classes*/
///////////////////////////////////////
/*
